...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Task Dictionary Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl2.myDsl.impl.TaskDictionaryEntryImpl#getValueName <em>Value Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl2.myDsl.impl.TaskDictionaryEntryImpl#getValueString <em>Value String</em>}</li>
 *   <li>{@link org.xtext.example.mydsl2.myDsl.impl.TaskDictionaryEntryImpl#getValueInt <em>Value Int</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskDictionaryEntryImpl extends MinimalEObjectImpl.Container implements TaskDictionaryEntry
{
  /**
   ...
   * @generated
   */
  protected TaskDictionaryEntryImpl()
  {
    super();
  }
  ...
  {
    return MyDslPackage.Literals.TASK_DICTIONARY_ENTRY;
  }
  ...
  public void setValueName(String newValueName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TASK_DICTIONARY_ENTRY__VALUE_NAME, oldValueName, valueName));
  }
  ...
  public void setValueString(String newValueString)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TASK_DICTIONARY_ENTRY__VALUE_STRING, oldValueString, valueString));
  }
  ...
  public void setValueInt(int newValueInt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TASK_DICTIONARY_ENTRY__VALUE_INT, oldValueInt, valueInt));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.TASK_DICTIONARY_ENTRY__VALUE_NAME:
        return getValueName();
      case MyDslPackage.TASK_DICTIONARY_ENTRY__VALUE_STRING:
        return getValueString();
      case MyDslPackage.TASK_DICTIONARY_ENTRY__VALUE_INT:
        return getValueInt();
    }
