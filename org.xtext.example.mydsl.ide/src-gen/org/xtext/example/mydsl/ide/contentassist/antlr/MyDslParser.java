...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCRUDOperationsAccess().getUpdateOperationAssignment_1_3_2(), "rule__CRUDOperations__UpdateOperationAssignment_1_3_2");
			...
			builder.put(grammarAccess.getCRUDOperationsAccess().getCriteriaAssignment_1_3_7(), "rule__CRUDOperations__CriteriaAssignment_1_3_7");
			builder.put(grammarAccess.getCRUDOperationsAccess().getCriteriaAssignment_1_3_8_1(), "rule__CRUDOperations__CriteriaAssignment_1_3_8_1");
