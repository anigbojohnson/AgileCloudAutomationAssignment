...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   */
  @Override
  public EAttribute getCRUDOperations_UpdateOperation()
  {
    return (EAttribute)crudOperationsEClass.getEStructuralFeatures().get(4);
  }
   ...
   */
  @Override
  public EReference getCRUDOperations_Criteria()
  {
    return (EReference)crudOperationsEClass.getEStructuralFeatures().get(5);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(crudOperationsEClass, CRUD_OPERATIONS__UPDATE_OPERATION);
    createEReference(crudOperationsEClass, CRUD_OPERATIONS__CRITERIA);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getCRUDOperations_Type(), this.getOperation(), "type", null, 0, 1, CRUDOperations.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getCRUDOperations_Entries(), this.getCollectionEntry(), null, "entries", null, 0, -1, CRUDOperations.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCRUDOperations_UpdateOperation(), ecorePackage.getEString(), "updateOperation", null, 0, 1, CRUDOperations.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCRUDOperations_Criteria(), this.getCollectionEntry(), null, "criteria", null, 0, -1, CRUDOperations.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEEnumLiteral(operationEEnum, Operation.GET);
    addEEnumLiteral(operationEEnum, Operation.DELETE);
    addEEnumLiteral(operationEEnum, Operation.INSERT);
