 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ModelImpl#getConnection <em>Connection</em>}</li>
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
   ...
   * @ordered
   */
  protected EList<CRUDOperationAndCollectionSchema> statements;
   ...
   */
  @Override
  public EList<CRUDOperationAndCollectionSchema> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<CRUDOperationAndCollectionSchema>(CRUDOperationAndCollectionSchema.class, this, MyDslPackage.MODEL__STATEMENTS);
    }
    return statements;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.MODEL__STATEMENTS:
        getStatements().clear();
        getStatements().addAll((Collection<? extends CRUDOperationAndCollectionSchema>)newValue);
        return;
    }
