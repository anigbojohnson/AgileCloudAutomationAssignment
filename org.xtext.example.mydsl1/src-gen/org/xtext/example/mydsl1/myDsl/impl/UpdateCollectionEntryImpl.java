...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Update Collection Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.UpdateCollectionEntryImpl#getValueName <em>Value Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.UpdateCollectionEntryImpl#getValueString <em>Value String</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.UpdateCollectionEntryImpl#getValueInt <em>Value Int</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateCollectionEntryImpl extends MinimalEObjectImpl.Container implements UpdateCollectionEntry
{
  /**
   ...
   * @generated
   */
  protected UpdateCollectionEntryImpl()
  {
    super();
  }
  ...
  {
    return MyDslPackage.Literals.UPDATE_COLLECTION_ENTRY;
  }
  ...
  public void setValueName(String newValueName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.UPDATE_COLLECTION_ENTRY__VALUE_NAME, oldValueName, valueName));
  }
  ...
  public void setValueString(String newValueString)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.UPDATE_COLLECTION_ENTRY__VALUE_STRING, oldValueString, valueString));
  }
  ...
  public void setValueInt(int newValueInt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.UPDATE_COLLECTION_ENTRY__VALUE_INT, oldValueInt, valueInt));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.UPDATE_COLLECTION_ENTRY__VALUE_NAME:
        return getValueName();
      case MyDslPackage.UPDATE_COLLECTION_ENTRY__VALUE_STRING:
        return getValueString();
      case MyDslPackage.UPDATE_COLLECTION_ENTRY__VALUE_INT:
        return getValueInt();
    }
